...
if (isset($_POST['updateconfirm'])) {
    if (isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['email']) && isset($_POST['gender']) && isset($_POST['user_date']) && isset($_POST['address']) && isset($_POST['contact']))
    {
            ...
            if (sha1($_POST['oldpassword']) == $data['PASSWORD']) {
                ...
                if ($uppercase && $lowercase && $number && strlen($_POST['newpassword']) >= 8) {
                    if ($_POST['newpassword'] == $_POST['confirmpassword']) {
                        ...
                        $sql1 = "UPDATE bysap.Users SET fullname = '$fullname', email = '$_POST[email]', password = '$password', user_date = TO_DATE('$_POST[user_date]', 'YYYY-MM-DD'), gender = '$_POST[gender]', address = '$_POST[address]', contact = $_POST[contact] WHERE  user_id = $user_id";
        ...
        {
            $sql2 = "UPDATE bysap.Users SET fullname = '$fullname', email = '$_POST[email]', user_date = TO_DATE('$_POST[user_date]', 'YYYY-MM-DD'), gender = '$_POST[gender]', address = '$_POST[address]', contact = $_POST[contact] WHERE  user_id = $user_id";
...
header("location: setup_customer.php?id=$_POST[user_id]");
